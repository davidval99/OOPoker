 ...
 */
public class FiveCards extends Holdem {
    ...
    public void dealHoleCards(int numeroCartas) {
        for (Player player : activePlayers) {
            player.setCards(deck.deal(numeroCartas));
        }
        System.out.println();
        notifyPlayersUpdated(false);
    ...
    public void doShowdown() {
        ...
        for (Player playerToShow : showingPlayers) {
            HandPoker handPoker = new HandPoker(playerToShow.getCards());
        ...
        for (Player player : activePlayers) {
            ...
            HandPoker handPoker = new HandPoker(player.getCards());
